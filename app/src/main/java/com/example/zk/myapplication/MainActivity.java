...
import com.example.zk.myapplication.Util.ApkInfo;
import com.example.zk.myapplication.Util.ApkUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // hookCookie.replaceClassLoader(getPackageName(),getClassLoader());
    }
    ...
    private void init() {
        ...
        if (this.mHasRoot) {
            charSequence = "作者支付宝帐号：15900582849";
        } else {
            charSequence = "同学请注意，你没有root!\n作者支付宝帐号：15900582849";
        }
